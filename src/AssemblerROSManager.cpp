...
AssemblerROSManager::Impl::Impl() : manager(nullptr), node_name("assembler_node"), left_trans(nullptr), right_trans(nullptr)
{
...
void AssemblerROSManager::Impl::processJoyState(joystate &state, const sensor_msgs::msg::Joy &msg)
{
...
void AssemblerROSManager::Impl::rosMain()
{
    try {
...
SgPosTransformPtr AssemblerROSManager::Impl::renderAxis(const Isometry3 &_pos)
{
...
Isometry3 &AssemblerROSManager::offset()
{
    return impl->world_offset;
}
const Isometry3 &AssemblerROSManager::offset() const
{
    return impl->world_offset;
}
void AssemblerROSManager::setOffset(Isometry3 &_T)
{
